...
public class ObjectTreeParser {
	...
	private HashMap<String, Class<? extends Object>> nameToClass = new HashMap<>();
	 ...
	 */
	private Object typeValue(String value, Class<? extends Object> clazz) throws SlickXMLException {
