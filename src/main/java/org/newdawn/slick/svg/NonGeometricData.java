...
public class NonGeometricData {
    ...
    public Color getAsColor(String attribute) {
        if (!isColor(attribute)) {
            throw new SlickException("Attribute " + attribute + " is not specified as a color:" + getAttribute(attribute));
        }
    ...
    public float getAsFloat(String attribute) {
        ...
        try {
            ...
            throw new SlickException("Attribute " + attribute + " is not specified as a float:" + getAttribute(attribute));
        }
    }
