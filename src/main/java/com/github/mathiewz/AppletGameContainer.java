...
import com.github.mathiewz.openal.SoundStore;
import com.github.mathiewz.opengl.CursorLoader;
...
public class AppletGameContainer extends Applet {
    ...
    protected transient ContainerPanel canvas;
    ...
    public void init() {
        ...
        try {
            ...
            Log.error(e);
            throw new SlickException("Unable to create game container");
        }
    }
        ...
        public void start() {
            ...
            try {
                ...
                try {
                    Thread.sleep(1000);
                    createDisplay();
                } catch (InterruptedException | LWJGLException nestedEx) {
                    throw new SlickException("Failed to create display", nestedEx);
                }
            }
    ...
    public class Container extends GameContainer {
        ...
        private static final String MOUSE_CURSOR_ERROR = "Failed to set mouse cursor";
        ...
        /**
         * @see com.github.mathiewz.GameContainer#getScreenHeight()
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#getScreenWidth()
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#hasFocus()
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setIcon(java.lang.String)
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setMouseGrabbed(boolean)
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#isMouseGrabbed()
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setMouseCursor(java.lang.String,
         *      int, int)
         */
        @Override
        public void setMouseCursor(String ref, int hotSpotX, int hotSpotY) {
            try {
                ...
                throw new SlickException(MOUSE_CURSOR_ERROR, e);
            }
        }
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setIcons(java.lang.String[])
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setMouseCursor(com.github.mathiewz.opengl.ImageData, int, int)
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setMouseCursor(org.lwjgl.input.Cursor, int, int)
         */
        @Override
        ...
        /**
         * @see com.github.mathiewz.GameContainer#setDefaultMouseCursor()
         */
        @Override
        ...
        public void setFullscreen(boolean fullscreen) {
            ...
            try {
                if (fullscreen) {
                    ...
                    getInput().setOffset(-xoffset * (float) width / newWidth, -yoffset * (float) height / newHeight);

                    getInput().setScale((float) width / newWidth, (float) height / newHeight);
                    ...
                    // restore input
                    getInput().setOffset(0, 0);
                    getInput().setScale(1, 1);
                    width = AppletGameContainer.this.getWidth();
                    height = AppletGameContainer.this.getHeight();
