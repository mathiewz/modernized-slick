...
public abstract class BasicComponent extends AbstractComponent {
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#getX()
     */
    @Override
    public int getX() {
        return x;
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#getY()
     */
    @Override
    public int getY() {
        return y;
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#render(com.github.mathiewz.gui.GUIContext, com.github.mathiewz.Graphics)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#setLocation(int, int)
     */
    @Override
