...
import com.github.mathiewz.Sound;
...
public class MouseOverArea extends AbstractComponent {
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#render(com.github.mathiewz.gui.GUIContext,
     *      com.github.mathiewz.Graphics)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.util.InputAdapter#mouseMoved(int, int, int, int)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.util.InputAdapter#mouseDragged(int, int, int, int)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#getHeight()
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.gui.AbstractComponent#getWidth()
     */
    @Override
    public int getWidth() {
