...
public interface Muffin {
     ...
     */
    public abstract void saveFile(HashMap<String, ? extends Object> data, String fileName) throws IOException;
     ...
     */
    public abstract HashMap<String, ? extends Object> loadFile(String fileName) throws IOException;
}
