package com.github.mathiewz.slick.fills;
...
public class GradientFill implements ShapeFill {
    /** The contant offset */
    private final Vector2f none = new Vector2f(0, 0);
    ...
    /**
     * @see com.github.mathiewz.slick.ShapeFill#getOffsetAt(com.github.mathiewz.slick.geom.Shape, float, float)
     */
    @Override
