...
import com.github.mathiewz.slick.particles.ConfigurableEmitter.ColorRecord;
import com.github.mathiewz.slick.particles.ConfigurableEmitter.LinearInterpolator;
import com.github.mathiewz.slick.particles.ConfigurableEmitter.RandomValue;
import com.github.mathiewz.slick.particles.ConfigurableEmitter.SimpleValue;
...
public class ParticleIO {
    ...
    public static ParticleSystem loadConfiguredSystem(InputStream ref, ConfigurableEmitterFactory factory, ParticleSystem system, Color mask) throws IOException {
        if (factory == null) {
            factory = ConfigurableEmitter::new;
        }
        try {
            ...
            if (system == null) {
                system = new ParticleSystem("com/github/mathiewz/slick/data/particle.tga", 2000, mask);
            }
