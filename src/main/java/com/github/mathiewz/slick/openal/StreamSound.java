...
public class StreamSound extends AudioImpl {
    ...
    /**
     * @see com.github.mathiewz.slick.openal.AudioImpl#isPlaying()
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean, float, float, float)
     */
    @Override
