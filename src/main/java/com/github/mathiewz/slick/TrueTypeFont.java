...
import com.github.mathiewz.slick.opengl.GLUtils;
...
import com.github.mathiewz.slick.util.BufferedImageUtil;
 ...
 */
public class TrueTypeFont implements com.github.mathiewz.slick.Font {
    ...
    /**
     * In this case equal to {@link com.github.mathiewz.slick.Font#getLogicalWidth(String)}
     *
     ...
     */
    @Override
    public void drawString(float x, float y, String whatchars, com.github.mathiewz.slick.Color color) {
        drawString(x, y, whatchars, color, 0, whatchars.length() - 1);
    }
    
    /**
     * @see Font#drawString(float, float, String, com.github.mathiewz.slick.Color, int, int)
     */
    @Override
    public void drawString(float x, float y, String whatchars, com.github.mathiewz.slick.Color color, int startIndex, int endIndex) {
        color.bind();
        fontTexture.bind();
    ...
    public void drawString(float x, float y, String whatchars) {
        drawString(x, y, whatchars, com.github.mathiewz.slick.Color.white);
    }
