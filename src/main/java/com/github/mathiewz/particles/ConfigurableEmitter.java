...
import com.github.mathiewz.util.FastTrig;
...
public class ConfigurableEmitter implements ParticleEmitter {
    ...
    /**
     * @see com.github.mathiewz.particles.ParticleEmitter#update(com.github.mathiewz.particles.ParticleSystem,
     *      int)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.particles.ParticleEmitter#updateParticle(com.github.mathiewz.particles.Particle,
     *      int)
     */
    @Override
    public void updateParticle(Particle particle, int delta) {
        ...
        particle.adjustVelocity(windFactor.getValue(0) * 0.00005f * delta, gravityFactor.getValue(0) * 0.00005f * delta);
    ...
    public boolean usePoints(ParticleSystem system) {
        return usePoints == Particle.INHERIT_POINTS && system.usePoints() || usePoints == Particle.USE_POINTS;
    }
