...
import com.github.mathiewz.opengl.TGAImageData;
...
public class AppGameContainer extends GameContainer {
    ...
    /**
     * @see com.github.mathiewz.GameContainer#setMouseCursor(java.lang.String, int, int)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.GameContainer#setMouseCursor(com.github.mathiewz.Image, int, int)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.GameContainer#reinit()
     */
    @Override
    public void reinit() {
    ...
    protected void setup() {
        ...
        AccessController.doPrivileged((PrivilegedAction<Void>) () -> {
            try {
                PixelFormat format1 = new PixelFormat(8, 8, stencil ? 8 : 0, samples);
                
                tryCreateDisplay(format1);
                supportsMultiSample = true;
            } catch (Exception e) {
                Display.destroy();
                
                try {
                    PixelFormat format2 = new PixelFormat(8, 8, stencil ? 8 : 0);
                    
                    tryCreateDisplay(format2);
                    alphaSupport = false;
                } catch (Exception e2) {
                    Display.destroy();
    ...
    /**
     * @see com.github.mathiewz.GameContainer#setUpdateOnlyWhenVisible(boolean)
     */
    @Override
    ...
    /**
     * @see com.github.mathiewz.GameContainer#isUpdatingOnlyWhenVisible()
     */
    @Override
