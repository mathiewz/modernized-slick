...
import com.github.mathiewz.geom.ShapeRenderer;
...
public class Graphics {
    ...
    /** The matrix stack */
    private final ArrayList<FloatBuffer> stack = new ArrayList<>();
    ...
    public Graphics(int width, int height) {
        if (DEFAULT_FONT == null) {
            AccessController.doPrivileged((PrivilegedAction<Void>) () -> {
                try {
                    DEFAULT_FONT = new AngelCodeFont("com/github/mathiewz/data/defaultfont.fnt", "com/github/mathiewz/data/defaultfont.png");
